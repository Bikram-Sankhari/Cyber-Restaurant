...
function getLocation() {
    $('#foodbakery_radius_location_open').html('<div class="spinner-border" style="width:1rem;height:1rem;" role="status" ></div>')
...
function error(err) {
    ...
    $('#foodbakery_radius_location_open').html('<i onclick="getLocation()" class="icon-target5"></i>')
}
